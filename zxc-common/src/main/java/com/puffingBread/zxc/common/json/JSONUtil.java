 ...
 *  使用方法：
 *  
 *   JSONUtils.fromJson(result, new TypeToken<UsersVO>() {});
 *   UsersVO{int code,String message,List<User> object}
 *   
 *   TypeToken<Result> type = new com.google.gson.reflect.TypeToken<Result>(){};
 *	 Result r = JSONUtils.fromJson(resultStr, type); 
 *	 Result{int code,String message,Object object}
 *
 *	 TypeToken<ArrayList<String>> token = new TypeToken<ArrayList<String>>() {};
 *   ArrayList<String> as = JSONUtils.fromJson(jsonstr, token);
 *   
 * <p /> 
