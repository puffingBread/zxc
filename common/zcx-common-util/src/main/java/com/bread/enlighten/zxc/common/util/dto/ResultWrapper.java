...
public class ResultWrapper<T> extends BaseDTO {
	...
	public ResultWrapper(Integer status, String msg) {
		this.status = status;
		this.msg = msg;
	}
	...
	public ResultWrapper(Integer status, String msg, T data, Error error) {
		this.status = status;
		this.msg = msg;
		this.data = data;
		this.error = error;
	 ...
	 * @return
	 */
	private static <T> ResultWrapper<T> fail() {
		ResultWrapper<T> resultWrapper = new ResultWrapper<>();
	...
	public static <T> ResultWrapper<T> fail(T data, String msg) {
	...
	public static <T> ResultWrapper<T> fail(Error error, T data) {
		ResultWrapper<T> wrapper = fail();
		wrapper.setData(data);
