package com.bread.zxc.common.utils;
...
public final class DateTime {
	...
	public static long getSecondsByDate(String date) {
		...
		calendar.setTime(stringtoDate(date, DateTime.LONG_DATE_FORMAT));
	...
	public static long getSecondsByDateTime(String dateTime) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(stringtoDate(dateTime, DateTime.FORMAT_ONE));
		return calendar.getTimeInMillis() / 1000;
	}
	...
	public static int getMonthTimeStmp(int timeStmp){
		...
		return DateTime.getTimeStmp(df.format(c.getTime()));
	}
...
//		System.out.println(getDate());
		Integer currTime = DateTime.getCurrTime();
		currTime = Integer.parseInt(String.valueOf(DateTime.getSecondsByDateTime("2017-02-28 12:34:56")));
		long sss = DateTime.getMonthTimeStmp(currTime);
		System.out.println("当前时间戳：" + currTime);
		System.out.println("当前时间戳2：" + sss);
		System.out.println("ttt:" + DateTime.getTime(sss * 1000));
		System.out.println("当前时间戳3：" + DateTime.getTime(1452239640));
//		
...
//		System.out.println("ff:" + ff);
		System.out.println(subMonth(DateTime.getCurrTime(), 1));
