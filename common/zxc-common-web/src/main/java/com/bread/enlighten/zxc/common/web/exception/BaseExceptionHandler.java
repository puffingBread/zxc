...
import com.bread.enlighten.zxc.common.util.dto.ResultWrapper;
import com.bread.enlighten.zxc.common.web.utils.ResultWrapperUtil;
...
public class BaseExceptionHandler {
    ...
    @PostConstruct
    public void init() {
        log.info("-//(ǒ.ǒ)//- Marketplus BaseExceptionHandler");
    }
    ...
    public ResultWrapper<?> handleConstraintViolationException(ConstraintViolationException e, Locale locale, ContentCachingRequestWrapper request) {
        ...
        if (request != null) {
            ...
            log.warn("business.check.incorrect: {}", errMsg, e);
        } else {
            log.warn("business.check.incorrect", e);
        }
